...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1778808426ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=user_data&table=scheduler">`user_data`.`scheduler`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4f38536c2b51767e6333224350406e46">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">&lt;div class=&quot;alert alert-danger&quot; role=&quot;alert&quot;&gt;&lt;h1&gt;Error&lt;/h1&gt;&lt;p&gt;&lt;strong&gt;SQL query:&lt;/strong&gt;  &lt;a href=&quot;#&quot; class=&quot;copyQueryBtn&quot; data-text=&quot;SET time_zone = &amp;quot;+00:00&amp;quot;&quot;&gt;Copy&lt;/a&gt;
&lt;a href=&quot;index.php?route=/database/sql&amp;sql_query=SET+time_zone+%3D+%22%2B00%3A00%22&amp;show_query=1&amp;db=user_data&quot;&gt;&lt;span class=&quot;nowrap&quot;&gt;&lt;img src=&quot;themes/dot.gif&quot; title=&quot;Edit&quot; alt=&quot;Edit&quot; class=&quot;icon ic_b_edit&quot;&gt;&amp;nbsp;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="phpmyadmin" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
...
&lt;a href=&quot;index.php?route=/database/sql&amp;sql_query=SET+time_zone+%3D+%22%2B00%3A00%22&amp;show_query=1&amp;db=user_data&quot;&gt;&lt;span class=&quot;nowrap&quot;&gt;&lt;img src=&quot;themes/dot.gif&quot; title=&quot;Edit&quot; alt=&quot;Edit&quot; class=&quot;icon ic_b_edit&quot;&gt;&amp;nbsp;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="user_data" targettable="scheduler">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `user_data`.`scheduler` ( `id` INT(3) NOT NULL AUTO_INCREMENT ,  `firstname` VARCHAR(20) NOT NULL ,  `lastname` VARCHAR(20) NOT NULL ,  `gender` ENUM(&#039;m&#039;,&#039;f&#039;,&#039;n&#039;) NOT NULL ,  `age` INT(3) NOT NULL ,  `dob` DATE NOT NULL ,  `email` VARCHAR(50) NOT NULL ,  `punctual` VARCHAR(50) NOT NULL ,  `task1` VARCHAR(50) NOT NULL ,  `task2` VARCHAR(50) NOT NULL ,  `task3` VARCHAR(50) NOT NULL ,  `task4` VARCHAR(50) NOT NULL ,  `task5` VARCHAR(50) NOT NULL ,  `task6` VARCHAR(50) NOT NULL ,  `task7` VARCHAR(50) NOT NULL ,  `task8` VARCHAR(50) NOT NULL ,  `institute` VARCHAR(50) NOT NULL ,  `institute_name` VARCHAR(50) NOT NULL ,  `dt` DATETIME(6) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `scheduler`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="user_data" targettable="scheduler">
                            <div class="action_content">
